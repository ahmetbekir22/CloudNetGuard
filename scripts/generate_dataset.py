...
def generate(
    ...
    # rate parametresi ile gerçekçi timestamp'ler simüle edilir
    packets = gen.generate_batch(n_samples, rate=rate)

    os.makedirs(os.path.dirname(output_path) or ".", exist_ok=True)

    header = FEATURE_NAMES + ["label"]

    # Her dataset üretimi için izole bir tracker — global tracker'ı kirletmez
